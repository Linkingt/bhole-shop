...
public class RedisUtils {
     ...
     * 存入缓存时，同时设定失效时间，默认秒
     */
    public void setWithExpireSeconds(String key, Object value, long time) {
        setWithExpire(key, value, time, TimeUnit.SECONDS);
    }

    /**
     * 存入缓存时，同时设定失效时间，默认分
     */
    public void setWithExpireMinutes(String key, Object value, long time) {
        setWithExpire(key, value, time, TimeUnit.MINUTES);
    }

    /**
     * 存入缓存时，同时设定失效时间，默认时
     */
    public void setWithExpireHours(String key, Object value, long time) {
        setWithExpire(key, value, time, TimeUnit.HOURS);
    }
    ...
    public void setWithExpire(String key, Object value, long time, TimeUnit timeUnit) {
        try {
            ...
            log.error("redis set error. key = {}; ==============={}", key, e.getMessage());
     ...
     * 根据Key设置过期时间，默认秒
     */
    public void expireSeconds(String key, long time) {
     ...
     * 根据Key设置过期时间，默认时
     */
    public void expireHours(String key, long time) {
    ...
    public boolean expire(String key, long time) {
        try {
            ...
            log.error("redis expire error. key = {}; ==============={}", key, e.getMessage());
            if (e instanceof RedisConnectionFailureException) {
                RedisConnectionUtils.unbindConnection(Objects.requireNonNull(redisTemplate.getConnectionFactory()));
            }
            return false;
    ...
    public Object get(String key) {
        try {
            ...
            log.error("redis get error. key = {}; ==============={}", key, e.getMessage());
            if (e instanceof RedisConnectionFailureException) {
    ...
    public Set<String> getKeys(String keys) {
        try {
            ...
            log.error("redis getKeys error. key = {}; ==============={}", keys, e.getMessage());
            if (e instanceof RedisConnectionFailureException) {
                RedisConnectionUtils.unbindConnection(Objects.requireNonNull(redisTemplate.getConnectionFactory()));
            }
        }
